...
```plain
### Added
- Ado Elastic Pool functions

### Changed
- Formatting Pool functions

## [0.1.37] - 2023-07-27

```plain
### Fixed
- Update-AdoAzureArmEndpoint and Update-AdoEndpoint

## [0.1.36] - 2023-07-19

```plain
### Added
- Added Update-AdoAzureArmEndpoint and Update-AdoEndpoint
